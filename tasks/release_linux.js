...
var init = function () {
    ...
    homeAppDir = packDir.cwd(userhome(), "." + manifest.name);
    readyAppDir = packDir.cwd('opt', manifest.name);
    /*console.log("HOMEDIRPATH", userhome());
    console.log("manifest.productName", manifest);*/
    return Q();
};
...
var finalize = function () {
    ...
    //projectDir.copy('app.db', readyAppDir.path('resources/app.db'));
    //readyAppDir.write('resources/app.db', " ");
